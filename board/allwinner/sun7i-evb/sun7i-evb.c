...
{
	printf("chear: board_mmc_init ---> \n CONFIG_MMC_SUNXI_SLOT = %d \n" ,CONFIG_MMC_SUNXI_SLOT);
	printf("mmc_card_no = %d \n" , mmc_card_no);
	sunxi_mmc_init(2); // modify by cjcheng for display_param
...
int checkboard(void)
{
	puts("Board: SUN7I-EVB & MarsBoard-A20 & Chear Testing\n");
	return 0;
}
#endif
